            ...
            <section id="billboard" className="overflow-hidden">
                ...
                <div className="main-swiper swiper">
                    <div className="swiper-wrapper">
                        <div className="swiper-slide" style={{ backgroundImage: "url('../../src/assets/images/banner1.jpg')", backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            ...
                                            <div className="btn-wrap">
                                                <Link to={ '../Shop'} className="d-flex align-items-center btn btn-light btn-medium" tabindex="0">Shop it now <i className="icon-arrow-io icon"></i>
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="swiper-slide" style={{ backgroundImage: "url('../../src/assets/images/banner2.jpg')", backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                            <div className="banner-content">
                                <div className="container">
                                    <div className="row">
                                        <div className="col-md-6">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eu feugiat amet, libero ipsum enim pharetra hac.</p>
                                            <div className="btn-wrap">
                                                <Link to={ '../Shop'} className="d-flex align-items-center btn btn-light btn-light-arrow btn-medium" tabindex="0">Shop it now <i className="icon-arrow-io icon"></i>
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="container">
                            <div className="d-flex flex-wrap justify-content-between align-items-center section-header">
                                ...
                                <div className="align-right btn-wrap">
                                    <a href="blog.html" className="d-flex align-items-center">View All Products <i className="icon-arrow-io icon icon"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div className="product-collection row">
                        <div className="left-content col-lg-7 col-md-12">
                            <div className="collection-item">
                                <div className="products-thumb">
                                    <img src="../../src/assets/images/collection-item1.jpg" alt="collection item" className="image-rounded large-image" />
                                </div>
                                <div className="col-sm-6 col-lg-6 col-md-6 product-entry">
                                    ...
                                    <div className="btn-wrap">
                                        <a href="shop.html" className="d-flex align-items-center">shop collection <i className="icon-arrow-io icon"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="right-content flex-wrap col-lg-5 col-md-12">
                            <div className="top-item collection-item">
                                <div className="products-thumb">
                                    <img src="../../src/assets/images/collection-item2.jpg" alt="collection item" className="image-rounded small-image" />
                                </div>
                            ...
                            <div className="bottom-item collection-item">
                                <div className="products-thumb">
                                    <img src="../../src/assets/images/collection-item3.jpg" alt="collection item" className="image-rounded small-image" />
                                </div>
                                <div className="col-md-6 product-entry">
                ...
                <div className="container">
                    <div className="product-collection">
                        <div className="left-content collection-item">
                            <div className="products-thumb">
                                <img src="../../src/assets/images/model.jpg" alt="collection item" className="image-rounded large-image" />
                            </div>
                            <div className="col-sm-6 col-lg-6 col-md-6 product-entry">
